...
from api.views.teacher.teacher_result.statistics.teacher_questype import TeacherQuesTypeView
...
urlpatterns = [
    ...
    path('teacher/teacher_result/statistics/teacher_questype/', TeacherQuesTypeView.as_view(), name='teacher_questype'),
]
if settings.DEBUG:
