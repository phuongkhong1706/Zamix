...
function TeacherScoreReviewExam() {
        ...
        <div className="sidebar-question-list">
          ...
          <div className="sidebar-question-buttons">
            {reviewData.questions.map((q, index) => {
              const isCorrect = q.teacher_answer === q.correct_answer;
              return (
                <button
                  key={index}
          ...
          return (
            ...
            >
              ...
              <ul style={{ listStyleType: "none", paddingLeft: 0 }}>
                {["A", "B", "C", "D"].map((option) => {
                  const selected = q.teacher_answer === option;
...
export default TeacherScoreReviewExam;
