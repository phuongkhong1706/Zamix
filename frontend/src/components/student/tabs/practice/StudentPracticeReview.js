...
function StudentPracticeReview() {
    ...
    <div style={{ display: "flex", padding: "20px", marginTop: "40px" }}>
      ...
      <div className="sidebar-container">
        ...
        <button
          ...
          onClick={() => window.location.reload()} // Có thể thay bằng navigate nếu muốn về lại màn hình chọn đề
        >
          Làm lại bài
        </button>
...
export default StudentPracticeReview;
